...
const ENTITY_TYPES = [
  { value: "project", label: "案件", icon: Building2 },
  { value: "worker", label: "作業員", icon: HardHat },
  { value: "subcontractor", label: "協力業者", icon: Handshake },
  { value: "phase", label: "工程", icon: Layers },
  { value: "daily_report", label: "日報", icon: FileText },
  { value: "inspection", label: "検査", icon: ClipboardCheck },
  { value: "corrective_action", label: "是正措置", icon: AlertOctagon },
];
    ...
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-12 pr-4 py-4 text-lg border border-gray-300 rounded-2xl bg-white shadow-sm focus:ring-2 focus:ring-gray-900 focus:border-gray-900 outline-none transition-all placeholder:text-gray-400"
      ...
      {showInitial && (
        <div className="text-center py-20">
          ...
          <p className="text-gray-500 text-sm mt-1">案件、作業員、協力業者、工程、日報、検査、是正措置から横断検索します</p>
        </div>
      )}
      ...
      {showEmpty && (
        <div className="text-center py-20">
          ...
          <p className="text-gray-500 text-sm mt-1">別のキーワードで検索するか、フィルターを変更してください</p>
        </div>
      )}
        ...
        <div className="space-y-3">
          ...
          {results.map(result => (
            <Link
              ...
              href={result.url}
              className="block bg-white border border-gray-200 rounded-2xl p-5 shadow-sm hover:shadow-md hover:border-gray-400 transition-all group"
            >
              <div className="flex items-start gap-4">
                ...
                <div className="text-gray-300 group-hover:text-gray-700 transition-colors flex-shrink-0">
